...
`apps/product-discovery/spike/embed-probe.html`. Run it before writing any code. Section 2 says how.
...
`apps/product-discovery/spike/embed-probe.html` answers the question in a few minutes. It is a
