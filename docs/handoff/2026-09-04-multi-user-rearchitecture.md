...
**Read these first, in order:** this file, then `apps/product-discovery/README.md` (what the tool
...
`apps/product-discovery/index.html`, about 1,900 lines, no build step and no dependencies beyond a
...
2. **No feature regressions.** Use `apps/product-discovery/README.md` as the acceptance checklist;
