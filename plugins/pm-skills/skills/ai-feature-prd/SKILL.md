...
| `pre-mortem` | Feeds into | AI-specific failure modes (hallucination, jailbreak, drift) populate the pre-mortem |
| `identify-assumptions` | Pairs with | "The base model can do this" is the single biggest AI-PRD assumption; validate before commit |
