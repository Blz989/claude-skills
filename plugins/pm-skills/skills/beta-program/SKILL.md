...
- A/B testing and statistical experiment design (see `brainstorm-experiments`)
...
| `identify-assumptions` | Receives from | Riskiest assumptions become the beta's primary learning goals |
| `brainstorm-experiments` | Complementary | Beta is one experiment type; brainstorm-experiments covers smaller/faster alternatives |
