...
**Out of Scope:** running validation experiments (`brainstorm-experiments/`); product strategy or roadmap decisions (`outcome-roadmap`); technical feasibility deep-dives (`engineering/` skills); financial modeling for viability (`finance/` skills).
...
| `create-prd` | Feeds into | Validated assumptions populate the PRD Assumptions section (Section 7) |
| `brainstorm-okrs` | Feeds into | Viability assumptions inform OKR key result selection and confidence levels |
