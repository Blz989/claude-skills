...
- `backlog-refinement` — pre-sprint item prep
- `story-splitting` — sizing large stories
- `cycle-time-analyzer` — velocity tracking
- `sprint-retrospective` — post-sprint learning
