...
- Product backlog prioritization and roadmap decisions (see `reference/prioritization-frameworks/`)
...
| `reference/brainstorm-okrs/` | Feeds into | Sprint capacity data helps set realistic OKR targets for the quarter |
| `reference/prioritization-frameworks/` | Receives from | Prioritized backlog items feed into sprint planning commitment decisions |
| `reference/pre-mortem/` | Receives from | Launch-blocking tigers may surface as sprint blockers requiring SM intervention |
