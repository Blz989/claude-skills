...
outcome. See `reference/north-star-metric`.
...
- `reference/identify-assumptions` — assumption surfacing
- `reference/brainstorm-experiments` — test design
- `reference/customer-interview-script` — interview prep
- `reference/interview-synthesis` — turn interviews into opportunities
- `reference/north-star-metric` — outcome definition
- `reference/lean-canvas` — strategic context
