...
- `reference/business-model-canvas` — operational view of each quadrant
- `reference/swot-analysis` — strategic context
- `reference/porters-five-forces` — industry analysis
