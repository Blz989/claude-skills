...
- `reference/business-model-canvas` — operating-scale variant
- `reference/value-proposition-canvas` — deeper on UVP
- `reference/identify-assumptions` — assumption register
- `reference/pre-mortem` — risk discovery
- `reference/north-star-metric` — Key Metric definition
