...
| `reference/create-prd/` | Feeds into | First-PRD template is a tighter version of the full PRD skill |
| `reference/interview-synthesis/` | Reuses | Customer interviews in week 5 use the same synthesis discipline as steady-state discovery |
