...
| `reference/brainstorm-experiments/` | Pairs with | Experiment toggles operationalize Lean experiments |
| `reference/pre-mortem/` | Pairs with | Pre-mortem risks inform kill-switch thresholds |
